            ...
            <b-tab title="General Setting" :title-link-class="linkClass(1)">
              <div>
                <b-tabs pills vertical v-model="genSetTabIndx">
                  ...
                  <b-tab
                    title="Notification"
                    :title-link-class="genSetTabClass(1)"
                  >
                    <b-card>
                      <b-card-text style="text-align: left">
                        <b-form-group>
                          <b-form-checkbox-group
                            id="checkbox-group-2"
                            v-model="selected_notif"
                            name="notif"
                          >
                            <div>
                              <b-form-checkbox value="savedBook"
                                >Saved Book</b-form-checkbox
                              >
                              <p class="small text-muted">
                                Notify me if saved book is available
                              </p>
                            </div>
                            <div>
                              <b-form-checkbox value="paymentDue"
                                >Payment Due</b-form-checkbox
                              >
                              <p class="small text-muted">
                                Remind me of payment dues
                              </p>
                            </div>
                            <div>
                              <b-form-checkbox value="bookReturn"
                                >Book Return</b-form-checkbox
                              >
                              <p class="small text-muted">
                                Notify me of book return dues
                              </p>
                            </div>
                            <div>
                              <div>
                                ...
                                >
                                  <p>
                                    Send me emails about my activity and updates
                                    I requested.
                                  </p>
                                </b-form-checkbox>
                              </div>
                  ...
                  <b-tab
                    ...
                    :title-link-class="genSetTabClass(2)"
                  >
                    <b-card>
                      <b-card-text style="text-align: left">
                        <div>
                          <b-form-group>
                            <b-form-radio
                              id="radio-1"
                              v-model="selected_paymentMethod"
                              value="cash"
                            >
                              <p>Cash</p>
                            </b-form-radio>
                            ...
                            >
                              ...
                              <ul class="links">
                                ...
                                <li>
                                  <a href="https://www.paymaya.com/"
                                    >Add Paymaya</a
                                  >
                                </li>
                                <li>
                                  <a href="https://www.paypal.com/ph/signin"
                                    >Add Paypal</a
                                  >
                                </li>
                              </ul>
            ...
            <b-tab title="Account Activity" :title-link-class="linkClass(2)">
              <div>
                <b-tabs pills vertical v-model="accActTabIndx">
                  ...
                  <b-tab
                    title="Loan History"
                    :title-link-class="accActTabClass(2)"
                  >
                    <b-card-text>
                      <div>
                        <b-table responsive :items="loans"></b-table>
